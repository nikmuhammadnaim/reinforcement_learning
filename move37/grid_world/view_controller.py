import time
from gui import GridWorldWindow
...
class ViewController(object):
    ...
    def __init__(self, metadata):
        ...
        self.mdp = MarkovDecisionProcess_Grid(metadata=metadata)
    ...
    def _value_iteration_slow(self):
        # run one iteration of value at a time
    ...
    def _policy_iteration_slow(self):
        # Run one iteration of policy at a time
